...
class ExceptionRootCauseResolverFactory implements TemplateResolverFactory<ExceptionRootCauseResolver> {
    ...
    @Override
    public ExceptionRootCauseResolver create(TemplateResolverContext context, String key) {
