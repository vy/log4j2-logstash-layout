...
class ContextStackResolverFactory implements TemplateResolverFactory<ContextStackResolver> {
    ...
    @Override
    public ContextStackResolver create(TemplateResolverContext context, String key) {
